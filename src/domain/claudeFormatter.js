...
// H-6 (Phase A 監査): TZ 依存を排除して曜日計算を安定化。
//   旧: `new Date(iso + "T00:00:00")` はローカル TZ 解釈、海外移動時に曜日が 1 日ずれる
//   新: ISO 文字列を手動 parse して new Date(y, m-1, d) で「ローカル TZ の 0:00」を明示
//       (どの TZ でも「YYYY-MM-DD」が指す日付の曜日が一意に決まる)
